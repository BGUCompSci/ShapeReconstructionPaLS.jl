...
function getPointCloudParamInternal(Mesh::RegularMesh, P::Array{Int64,1}, Normals::Array{Float64,2},ndipsAll::Int64,workerSubIdxs,samplingBinning::Int64,method)
	return PointCloudParam(Mesh, P::Array{Int64,1}, Normals::Array{Float64,2}, ndipsAll, workerSubIdxs, samplingBinning, method,spzeros(Float32,Int32,0,0));
end
		...
		for w = ActualWorkers
			@async begin
				while true
					...
					tmp = initRemoteChannel(getPointCloudParamInternal,w, Mesh,P::Array{Int64,1}, Normals::Array{Float64,2},ndips,I_p,samplingBinning,method);
					pFor[1]  = initRemoteChannel(getPointCloudParamInternal,w, Mesh,P::Array{Int64,1}, Normals::Array{Float64,2},ndips,I_p,samplingBinning,method);
					wait(pFor[1]);
